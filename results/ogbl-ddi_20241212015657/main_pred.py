...
def main(rank, args, data_pos_train, data_neg_train, data_pos_valid, data_neg_valid, data_pos_test, data_neg_test):
    ...
    data_pos_train = data_pos_train.to(rank)
    data_neg_train = data_neg_train.to(rank)
    data_pos_valid = data_pos_valid.to(rank)
    data_neg_valid = data_neg_valid.to(rank)
    data_pos_test = data_pos_test.to(rank)
    data_neg_test = data_neg_test.to(rank)
